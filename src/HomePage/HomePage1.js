	...
	render() {
		...
		return (
				...
				<div className="form-style-5">
					...
					<form onSubmit={this.handleSubmit}>
						...
						<legend><span className="number">1</span> Catch Information</legend>
							...
							<div>
								<input style={{"width":"49%","marginRight":"0px" }}name="species" type="text" placeholder="Species Name" value={this.state.species} onChange={this.handleChange} />
			...
			<div style={{"float": "left", "margin": "10px", "width": "40%"}}>
					<div style={{"position": "relative", "bottom": "10px"}}><h2><b></b></h2><p style={{"fontSize": "30px", "width": "30em"}}>{text}</p></div>
			</div>
			
			<div style={{"float": "right", "margin": "10px", "width": "40%"}}>
					<div style={{"position": "relative", "bottom": "10px"}}><h3><b></b></h3><p style={{"fontSize": "30px", "width": "30em"}}>{text1}</p></div>
			</div>

			<div style={{"float": "left", "margin": "10px", "width": "40%"}}>
					<div style={{"position": "relative", "bottom": "10px"}}><h2><b></b></h2><p style={{"fontSize": "18px", "width": "30em"}}>{text2}</p></div>
			</div>
