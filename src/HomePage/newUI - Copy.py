...
"")
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 651, 201))
        self.label.setStyleSheet("font: 75 23pt \"Century Gothic\";")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(30, 20, 591, 311))
...
"background: transparent;")
        ...
        self.pushButton_5.clicked.connect(self.uploadToServer)
